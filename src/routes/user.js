...
router.route('/:id/lists')
  /**
   * @api {get} /api/users/:id/lists Get user lists
   ...
   *   ]
   */
  .get(userMiddleware.getUserLists)

router.route('/:id/stories')
  /**
   * @api {get} /api/users/:id/stories Get user stories
   ...
   *  ]
   */
  .get(userMiddleware.getUserStories)
